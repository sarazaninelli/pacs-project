...
Real u2 (const Real& t, const Real& x, const Real& /*y*/, const Real& /*z*/, const ID& i)
{
    switch (i)
    {
        ...
        case 2:
            //if ( t <= 0.003 )
            //{
                return 1*sin(2*3.1415*0.01/0.1)/*100*//*1.3332e4*/;
            //}
            //      return 0.01;
            return 0.0;
            break;
               ...
               const ID&   id ) const
    {
        ...
        switch (id)
        {
            ...
            case 2: // z component
                if ( t <= 10 )
                {
                    return  20; //100*(t+5*0.01); //1.3332e4;
                }
                //      return 0.01;
                return 0.0;
                break;
    ...
    d ( new Private )
{
    ...
    d->H           = dataFile( "fluid/problem/H", 20. );
...

{
    ...
    BCFunctionBase uIn  (  d->getU_2d() ); //profilo piatto
    BCFunctionBase uOne (  d->getU_one() );
    BCFunctionBase uPois (  d->getU_pois() ); //profilo parabolico

    BCFunctionBase velo ( u2 );
    //cylinder
